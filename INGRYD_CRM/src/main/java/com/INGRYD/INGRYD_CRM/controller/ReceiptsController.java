...
public class ReceiptsController {
    ...
    @PostMapping
    @Transactional
    public ResponseEntity<Receipt> createReceipt (String receiver, @RequestBody Payment payment) throws IOException, MessagingException {
        return receiptsService.createReceipt(receiver,payment);
    }
